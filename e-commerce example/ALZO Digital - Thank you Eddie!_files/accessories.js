...
var accessoriesJS = function ($) {
    ...
    if (!document.getElementById(cssId)) {
        ...
        link.rel = 'stylesheet';
        link.type = 'text/css';
        link.href = 'https://accessories.w3apps.co/api/css?shopName=' + Shopify.shop + "&c=" + Math.random();
        link.media = 'all';
...
function getAccessories($, id) {
    ...
    $.ajax({
        type: 'GET',
        url: "https://accessories.w3apps.co/api/accessories",
        data: productRequest,
        dataType: "jsonp",
                ...
                if (myProduct.images.length >= 1) {
                    ...
                    if (accessoriesData.disable_quick_view == false) {
                        ...
                        btnQuickView.click(function (e) {
                            ...
                            modalRight.append(product.description);
